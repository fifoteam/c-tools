...
typedef enum ivl_process_type_e {
      IVL_PR_INITIAL = 0,
      IVL_PR_ALWAYS  = 1,
      IVL_PR_ALWAYS_COMB  = 2,
      IVL_PR_ALWAYS_LATCH = 3,
      IVL_PR_ALWAYS_FF    = 4   
} ivl_process_type_t;
...
typedef enum ivl_signal_type_e {
      ...
      IVL_SIT_TRI0,//Ansuk
      IVL_SIT_TRI1,//Ansuk
      IVL_SIT_TRIAND,//Ansuk
      IVL_SIT_TRIREG,//Ansuk 
      IVL_SIT_TRIWAND,//Ansuk
      IVL_SIT_TRIOR,//Ansuk
      IVL_SIT_TRIWOR//Ansuk
} ivl_signal_type_t;
...
extern unsigned    ivl_event_nchanged(ivl_event_t net);  // Guru
extern ivl_nexus_t ivl_event_changed(ivl_event_t net, unsigned idx);  // Guru

extern unsigned    ivl_event_niff(ivl_event_t net);  // Guru
extern ivl_nexus_t ivl_event_iff(ivl_event_t net, unsigned idx);  // Guru

//Ansuk
extern ivl_event_type_t ivl_event_type(ivl_event_t net);
...
extern ivl_process_type_t ivl_lpm_process_type(ivl_lpm_t net);
...
/* IVL_LPM_LATCH */
extern ivl_nexus_t ivl_lpm_gate( ivl_lpm_t net);
  /* IVL_LPM_FF */
